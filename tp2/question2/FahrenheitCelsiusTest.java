...
public class FahrenheitCelsiusTest extends junit.framework.TestCase
{
    ...
    public void test_fahrenheitEnCelsius() {
		...
		assertEquals ("  155 °F ->68.3°C ?", 68.3, question1.FahrenheitCelsius.fahrenheitEnCelsius(155), 0.1);
		assertEquals ("  255 °F -> -123.8 °C ?", 123.8, question1.FahrenheitCelsius.fahrenheitEnCelsius(255), 0.1);
		assertEquals ("  300 °F -> 148.8 °C ?",148.8,  question1.FahrenheitCelsius.fahrenheitEnCelsius(300), 0.1);
		assertEquals (" 555 °F -> 290.5 °C ?",290.5,  question1.FahrenheitCelsius.fahrenheitEnCelsius(555), 0.1);
	}
